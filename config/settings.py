...
SECRET_KEY = os.environ.get("SECRET_KEY", "django-insecure-39c_q&6mr3=2g3mo+i&qh0sglodf3#a!k*@g0i%na+i*c7e&v1")
...
SPECTACULAR_SETTINGS = {
    "TITLE": "Nexus API",
    "DESCRIPTION": "Backend API for Clipping Agency Manager",
    "VERSION": "1.0.0",
    "SERVE_INCLUDE_SCHEMA": False,
}

# Mixpost Integration
# Default to Docker service name + api prefix
MIXPOST_API_URL = os.environ.get("MIXPOST_API_URL", "http://nexus-mixpost-app-1:80/mixpost") 
MIXPOST_API_TOKEN = os.environ.get("MIXPOST_API_TOKEN", "")
