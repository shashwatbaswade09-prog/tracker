...
const AdminSidebar = () => {
    ...
    const menuItems = [
        ...
        { icon: <Target size={20} />, label: 'Campaigns', path: '/admin/campaigns' },
        { icon: <ClipboardList size={20} />, label: 'Submissions', path: '/admin/submissions' },
        { icon: <Globe size={20} />, label: 'Network', path: '/admin/network' },
    ...
    return (
        <aside className="w-64 h-screen fixed left-0 top-0 bg-black border-r border-orange-500/10 flex flex-col z-50 overflow-hidden">
            <div className="p-6 border-b border-orange-500/10 flex items-center justify-center">
                <Link to="/" className="flex flex-col items-center gap-2 group">
                    ...
                    <span className="font-bold tracking-[0.2em] text-white uppercase text-[10px] mt-2 group-hover:text-orange-500 transition-colors">
                        Nexus <span className="text-orange-500 font-black">Admin</span>
                    </span>
                </Link>
            </div>
            ...
            <div className="p-6 border-t border-orange-500/10 bg-zinc-900/10">
                <div className="flex items-center gap-3 mb-6 p-2 rounded-lg bg-orange-500/5 border border-orange-500/10">
                    ...
                    <div className="flex-1 min-w-0">
                        ...
                        <p className="text-[10px] text-orange-500/70 truncate uppercase font-bold tracking-tighter">System Root</p>
                    </div>
                </div>
                <button
