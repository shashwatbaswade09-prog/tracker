...
class ConnectedAccountSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = ["id", "platform", "handle", "profile_url", "status", "verification_code", "verified_at", "verification_note", "created_at"]
        read_only_fields = ["id", "status", "verification_code", "verified_at", "verification_note", "created_at"]
